...
DATABASES = {
    # "default": dj_database_url.config(config("DATABASE_URL")),  # type: ignore
    "default": dj_database_url.config(default="postgresql://postgres:oEDIHbcPjenziFCYIkcjbWWoGUxOGGng@autorack.proxy.rlwy.net:50388/railway"),  # type: ignore
}
